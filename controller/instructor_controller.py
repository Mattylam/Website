...
def instructor_list():
    if User.current_login_user is not None:
        ...
        get_tuple = model_instructor.get_instructors_by_page(page)
        one_page_instructor_list = get_tuple[0]
...
def teach_courses():
    ...
    if User.current_login_user is not None:
        ...
        get_tuple = model_course.get_course_by_instructor_id(instructor_id)
        course_list = get_tuple[0]
        total_num = get_tuple[1]
